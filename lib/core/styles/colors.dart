...
abstract class AppColors {
  ...
  static const Color onPrimaryText = Color(0xFF000000);
  static const Color onSecondaryText = Color(0xFFA8A8A9);
  static const Color onSearch = Color(0xFFBBBBBB);
  static const Color onPrimaryReat = Color(0xFFEDB310);
  static const Color onSecondaryReat = Color(0xFFA4A9B3);
  static const Color likeBackground = Color(0xFFD9D9D9);
}